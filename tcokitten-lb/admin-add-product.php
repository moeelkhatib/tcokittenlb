...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Allow URL fallback if no upload
...
<body class="bg-gray-100">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="mt-6 bg-blue-50 border border-blue-100 rounded-lg p-6">
                        ...
                        <ul class="text-sm text-blue-700 space-y-2">
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-blue-500 mt-1 mr-2"></i>
                                <span>For discounted items, enter both original and current price</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-blue-500 mt-1 mr-2"></i>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            // Image validation
            if (imageUpload.files.length === 0 && !imageUrl.trim()) {
                if (!confirm('No image has been selected or provided. Continue without an image?')) {
                    e.preventDefault();
                    return false;
                }
            }
